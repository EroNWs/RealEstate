...
public class RealEstateTransactionForRentalConfiguration : IEntityTypeConfiguration<RealEstateTransactionForRental>
{
    ...
    {
        builder.ToTable("RealEstateTransactionForRentals")
            .HasKey(retfr => retfr.Id);


        builder.Property(retfr => retfr.CreatedDate)
            .HasColumnName("CreatedDate")
            .IsRequired();

        builder.Property(retfr => retfr.UpdatedDate)
            .HasColumnName("UpdatedDate");

        builder.Property(retfr => retfr.DeletedDate)
