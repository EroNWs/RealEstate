...
public class RealEstateTransactionForSaleConfiguration : IEntityTypeConfiguration<RealEstateTransactionForSale>
{
    ...
    {
        builder.ToTable("RealEstateTransactionForSales")
            .HasKey(retfs => retfs.Id);


        builder.Property(retfs => retfs.Id)
            .HasColumnName("Id")
            .IsRequired();

        builder.Property(retfs => retfs.CreatedDate)
            .HasColumnName("CreatedDate")
            .IsRequired();

        builder.Property(retfs => retfs.UpdatedDate)
            .HasColumnName("UpdatedDate");

        builder.Property(retfs => retfs.DeletedDate)
